...
export const PRODUCTS = [
  ...
  ["LIM-004", "Lavaplatos en crema 500 g", "limpieza", 1, "quimicos", 0.95, 1.9, 1.5, 12, 4],
  ...
  ["LIM-010", "Escoba plástica con palo", "limpieza", 6, "plasticos", 1.8, 3.5, 2.8, 8, 3],
  ...
  ["HOG-004", "Set de cubiertos x24", "hogar", 7, "ningbo", 5.4, 11.5, 9.3, 5, 2],
  ...
  ["FER-007", "Extensión eléctrica 5 m", "ferreteria", 3, "ningbo", 3.0, 6.5, 5.2, 11, 2],
  ...
  ["CUI-005", "Desodorante en barra 50 g", "cuidado", 1, "quimicos", 1.3, 2.9, 2.3, 9, 5],
