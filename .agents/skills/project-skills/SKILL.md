...
name: project-skills
description: >
  Master catalog of all Cendaro project skills. Lists 60+ skills across
  .agents/skills/ and .opencode/skills/ directories. Use when the user asks
  "what skills are available", "list skills", "find a skill for X", or when
  you need specialized knowledge for a task.
---

# Cendaro — Project Skills Catalog

This project has **60+ specialized skills** across two directories. Load any skill by reading its `SKILL.md` file.

## Primary Skills — `.agents/skills/` (41 skills)

Read the full README at `.agents/skills/README.md` for detailed descriptions.
...
| Skill                     | Path                                                | Use When                        |
| :------------------------ | :-------------------------------------------------- | :------------------------------ |
| copywriting               | `.agents/skills/copywriting/SKILL.md`               | Marketing copy for pages        |
| copy-editing              | `.agents/skills/copy-editing/SKILL.md`              | Edit/review existing copy       |
| seo-audit                 | `.agents/skills/seo-audit/SKILL.md`                 | Technical SEO audits            |
| ai-seo                    | `.agents/skills/ai-seo/SKILL.md`                    | AI search engine optimization   |
| schema-markup             | `.agents/skills/schema-markup/SKILL.md`             | JSON-LD structured data         |
| page-cro                  | `.agents/skills/page-cro/SKILL.md`                  | Conversion rate optimization    |
| cold-email                | `.agents/skills/cold-email/SKILL.md`                | B2B cold outreach               |
| email-sequence            | `.agents/skills/email-sequence/SKILL.md`            | Drip campaigns, nurture flows   |
| launch-strategy           | `.agents/skills/launch-strategy/SKILL.md`           | Product launch planning         |
| pricing-strategy          | `.agents/skills/pricing-strategy/SKILL.md`          | Pricing decisions, packaging    |
| sales-enablement          | `.agents/skills/sales-enablement/SKILL.md`          | Pitch decks, one-pagers         |
| marketing-psychology      | `.agents/skills/marketing-psychology/SKILL.md`      | Behavioral science in marketing |
| product-marketing-context | `.agents/skills/product-marketing-context/SKILL.md` | ICP, positioning docs           |
| analytics-tracking        | `.agents/skills/analytics-tracking/SKILL.md`        | GA4, GTM, event tracking        |
...
| email-best-practices | `.agents/skills/email-best-practices/SKILL.md` | SPF/DKIM, deliverability   |
...
4. **Adapt tool references** — if a skill references tools you don't have, substitute equivalents:
   - `TodoWrite` → use a markdown checklist
   - `Task` with subagents → use Codex's native subagent system
