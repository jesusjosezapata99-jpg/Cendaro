# Cendaro ERP — Codex Project Instructions

> This file is the single source of truth for Codex. It is read automatically at the start of every session.
...
> Full standards: `.Codex/rules/coding-standards.md` (loaded automatically by Codex)
...
Custom specialist agents in `.Codex/agents/`. Invoke by name or `@-mention`.
