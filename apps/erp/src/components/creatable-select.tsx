...
const inputBase =
  "w-full min-h-11 border border-border bg-card px-3 py-2.5 text-sm text-foreground outline-none transition-colors placeholder:text-muted-foreground focus:border-primary focus:ring-2 focus:ring-ring/20";
      ...
      {isCreating ? (
        <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            className="border-primary/30 bg-primary/10 text-primary hover:bg-primary/20 flex h-11 w-11 shrink-0 items-center justify-center border transition-colors disabled:opacity-40"
            title="Confirmar"
          >
          ...
          <button
            ...
            disabled={saving}
            className="text-muted-foreground hover:text-destructive border-border flex h-11 w-11 shrink-0 items-center justify-center border transition-colors"
            title="Cancelar"
          >
