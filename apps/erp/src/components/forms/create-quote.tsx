      ...
      <form onSubmit={handleSubmit} className="flex h-full flex-col">
        <SheetBody>
          ...
          <div>
            ...
            {lines.length > 0 && (
              <div className="border-border bg-card mobile-scroll-x mb-3 overflow-hidden border">
              ...
              <div className="relative" ref={dropdownRef}>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="border-border-subtle bg-card text-foreground placeholder:text-muted-foreground focus:border-primary focus:ring-ring/20 min-h-11 w-full border py-2.5 pr-4 pl-10 text-sm transition-colors outline-none focus:ring-2"
                  />
                  {selectedProduct && (
              ...
              <div className="flex flex-wrap items-end gap-2">
                <div className="w-20">
                  ...
                  <input
                    ...
                    className="border-border-subtle bg-card text-foreground placeholder:text-muted-foreground focus:border-primary focus:ring-ring/20 min-h-11 w-full border px-3 py-2.5 font-mono text-sm tabular-nums transition-colors outline-none focus:ring-2"
                  />
                </div>
                <div className="w-28">
                  <label className="text-muted-foreground mb-1 block text-[10px] tracking-wider uppercase">
                ...
                <button
                  ...
                  className="bg-primary text-primary-foreground hover:bg-primary/90 disabled:bg-muted disabled:text-muted-foreground min-h-11 px-3 py-2 text-xs font-medium transition-colors disabled:cursor-not-allowed"
                >
          ...
          <Field label="Notas / Términos">
            <textarea
              ...
              rows={2}
              className="border-border bg-card text-foreground placeholder:text-muted-foreground focus:border-primary focus:ring-ring/20 w-full border p-2.5 text-sm transition-colors outline-none focus:ring-2"
...
export const CreateQuoteSheet = CreateQuoteDialog;
