        ...
        <SheetBody>
                ...
                <div className="flex items-center gap-2">
                  ...
                  {pendingBalance > 0 && (
                    <button
                      ...
                      className="border-border hover:bg-muted/40 text-primary border px-1.5 py-0.5 text-[10px] font-medium transition-colors"
                    >
                      Usar saldo total
                    </button>
                  )}
          ...
          <Field label="Notas / Observaciones">
            <textarea
              ...
              className="border-border bg-card text-foreground placeholder:text-muted-foreground focus:border-primary focus:ring-ring/20 w-full border p-2.5 text-xs transition-colors outline-none focus:ring-1"
            />
          </Field>
        </SheetBody>
...
export const RegisterPaymentSheet = RegisterPaymentDialog;
