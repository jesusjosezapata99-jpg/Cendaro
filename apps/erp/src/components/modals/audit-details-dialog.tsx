          ...
          <div className="space-y-5">
            ...
            <div className="border-border bg-card space-y-3 border p-4">
              <div className="flex flex-wrap items-center justify-between gap-2">
                <div className="flex items-center gap-2">
                  <StatusPill tone={actionTone}>{entry.action}</StatusPill>
                  <span className="text-muted-foreground font-mono text-xs">
                    →
                  </span>
                  <span className="bg-secondary text-foreground border-border inline-flex items-center border px-2 py-0.5 text-xs font-medium">
                    {entry.entity}
                  </span>
                </div>
                ...
                {hasChanges ? (
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    <div>
                      ...
                      <pre className="bg-muted/40 border-border max-h-56 overflow-x-auto border p-3 font-mono text-[11px] leading-relaxed">
                        {entry.oldValue
                  ...
                  <div className="bg-muted/30 border-border text-muted-foreground border p-6 text-center text-xs">
            ...
            {activeTab === "metadata" && (
              <div className="space-y-2">
                ...
                <pre className="bg-muted/40 border-border max-h-64 overflow-x-auto border p-3 font-mono text-[11px] leading-relaxed">
                  {entry.metadata
            ...
            {activeTab === "network" && (
              <div className="border-border bg-card divide-border/60 divide-y border text-xs">
                ...
                <div className="space-y-1 p-3">
                  ...
                  <p className="text-foreground/80 bg-muted/40 border-border border p-2 font-mono text-[11px] break-all">
                    {entry.userAgent ??
        ...
        <SheetFooter>
          <div className="flex w-full justify-end">
            <button
              type="button"
              onClick={onClose}
              className="border-border bg-secondary text-foreground hover:bg-accent border px-4 py-2 text-xs font-medium transition-colors"
            >
              Cerrar Inspector
            </button>
          </div>
...
export const AuditDetailsSheet = AuditDetailsDialog;
