...
/**
 * Workspace stack — PLAN-2026-09-DESIGN-SYSTEM M-08, §5.8.1 (T2.3).
 * Fixed to the viewport (matching workspace switcher pattern, independent
 ...
 * there is no workspace-creation flow anywhere in the app yet (the old,
 * now-deleted `workspace-switcher.tsx` only had a dead placeholder button
 * for it) — the plan says to omit the button when no such flow exists.
 */
