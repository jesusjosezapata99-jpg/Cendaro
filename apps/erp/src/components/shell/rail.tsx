...
/**
 * Desktop rail — PLAN-2026-09-DESIGN-SYSTEM §5.8.1, M-01/M-02 (T2.2).
 * Hidden below `md`; the mobile drawer (T2.5) covers small screens.
 *
 * Expands 70→240px (M-01) on hover OR keyboard focus (DEV-4: Expands on hover and keeps focus-visible parity for keyboard users). The header (M-02) is absolutely positioned over the top so the
