...
/**
 * Dormant search trigger — PLAN-2026-09-DESIGN-SYSTEM §5.8.1 header spec,
...
export function OpenSearchButton({ onOpen }: OpenSearchButtonProps) {
  return (
    <>
      ...
      <button
        onClick={onOpen}
        className="text-muted-foreground hover:bg-accent hover:text-foreground flex size-11 items-center justify-center transition-colors sm:hidden"
        aria-label="Buscar"
      >
