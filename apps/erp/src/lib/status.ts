 ...
 * (PLAN-2026-09-DESIGN-SYSTEM §5.3, T1.9). Replaces the ~12 duplicated
 * status configuration maps that used to live inline in each page — labels are
 * preserved verbatim from those maps, only the tone assignment changed to
 * match Cendaro's 7-tone status vocabulary.
 */
